...
import { registerPatient, reset } from "@/redux/features/user-slice";
import { fetchDoctors, reset as doctorReset } from "@/redux/features/doctor-slice";
import { AppDispatch, RootState } from "@/redux/store";
import { RegisterPatientRequest } from "@/types/entities";
...
const RegisterForm = () => {
  ...
  const {isLoading, isError, isSuccess, message} = useSelector((state: RootState) => state.user);
  ...
  const onSubmit = (data: RegisterPatientRequest) => {
